...
function RenderAccidental(renderProps, note, type, offset, theme) {
    ...
    switch (type) {
        case 0:
            ...
            break;
        case 1:
            RenderSymbol(renderProps, StdAccidentals.Sharp, note.Bounds.x - offset, note.Bounds.y + 3, theme, note.Selected);
            break;
        case 2:
        ...
        case -1:
            ...
            posString += flatPath;
            RenderSymbol(renderProps, StdAccidentals.Flat, note.Bounds.x - offset, note.Bounds.y + 3, theme, note.Selected);
            break;
        default:
            break;
    }
