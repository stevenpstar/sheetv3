...
var mHeadXOffset = 3.4871;
var mHeadYOffset = -7.6;
// TODO: Re-work this function a bit, so many parameters and the note itself
// isn't even being passed in?
function RenderNote(note, renderProps, bounds, selected, colour) {
...
function RenderStem(ctx, notes, beatD, cam) {
    ...
    var middleLine = 15; // TODO: This will depend on measure height
    var dirUp = true; // default to true
    if (bdNotes.length === 1) {
