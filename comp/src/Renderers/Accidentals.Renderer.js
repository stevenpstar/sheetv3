...
function RenderAccidental(renderProps, note, type, theme) {
    ...
    switch (type) {
        ...
        case 1:
            ...
            posString += sharpPath;
            RenderSymbol(renderProps, StdAccidentals.Sharp, note.Bounds.x - 12, note.Bounds.y + 3, theme, note.Selected);
            break;
        case 2:
        ...
        case -1:
            ...
            posString += flatPath;
            RenderSymbol(renderProps, StdAccidentals.Flat, note.Bounds.x - 12, note.Bounds.y + 3, theme, note.Selected);
            break;
        default:
            break;
    }
