...
const quaverFlag =
  "c11.7122 2.9669 6.3069 13.252 5.2534 16.885 9.622-13.142-5.1221-18.5026-5.2534-26.47z";
const quaverFlagInverted =
  "c10.7362-2.7197 5.7813-12.1477 4.8156-15.4779 8.8202 12.0469-4.6953 16.9607-4.8156 24.2642z";
const noteXBuffer = 9;
...
function RenderStemRevise(
  ...
  if (
    middleLine - highestLine + staffTopLine <
    ...
    if (divisions.length === 1 && divisions[0].Duration < 0.25) {
      ...
      if (i === 0) {
        ...
        const newBeam = new Beam(
          new Bounds(divisions[0].Bounds.x + 19, stemEndY, 5, 5),
        ...
        newBeam.Render(
          context,
          camera,
          GetFlagCount(divisions[0].Duration),
          stemDirection,
          theme,
        );
      }
